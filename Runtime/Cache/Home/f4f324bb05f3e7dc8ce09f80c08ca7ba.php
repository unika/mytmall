			...
			<div class="list_search">
				<div class="index_new_mian">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list">
							<a target="_top" class="l_img" href="/Product/show/Id/<?php echo ($vo["Id"]); ?>" title="<?php echo ($vo["Name"]); ?>"><img src="/Upload/Product/<?php echo ($vo["Img"]); ?>" alt="Gucci Active Mask Sunglasses"></a>
