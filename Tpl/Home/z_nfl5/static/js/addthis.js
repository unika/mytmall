...
if (typeof addthis_widget == "undefined") {
    ...
    function at12Y() {
        ...
        var at12y = '<a href="' + at12I('') + '\" onclick=\"return addthis_to()\">'; at12y += '<img src="/static/skin/z_nfl5/img/button1-bm.gif" width="125" height="16" border="0" style="border: none; padding: 0px" alt="AddThis Social Bookmarking Widget" /></a>';
