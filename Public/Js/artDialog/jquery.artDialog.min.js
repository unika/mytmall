...
(function(e, t, n) {
	...
	var r, i = 0, s = document.activeElement, o = e(document.getElementsByTagName("html")[0]), u = "artDialog" + +(new Date), a = t.VBArray && !t.XMLHttpRequest, f = "createTouch" in document && !("onmousemove" in document) || /(iPhone|iPad|iPod)/i.test(navigator.userAgent), l = !a && !f, c = function(e, t, o) {
		...
		if (a)
			return p && a.follow(p), a.zIndex().focus(), s = document.activeElement, a;
		l || (e.fixed = !1);
		if (!e.button || !e.button.push)
			e.button = [];
		return t !== n && (e.ok = t), e.ok && e.button.push({
			id : "ok",
			value : e.okValue,
			callback : e.ok,
			focus : !0
		}), o !== n && (e.cancel = o), e.cancel && e.button.push({
			id : "cancel",
			value : e.cancelValue,
			callback : e.cancel
		}), c.defaults.zIndex = e.zIndex, i++, c.list[e.id] = r ? r.constructor(e) : new c.fn.constructor(e)
	};
	c.version = "5.0.3", c.fn = c.prototype = {
		...
		content : function(t) {
			...
			delete this._elemBack), typeof t == "string" ? u.html(t) : t && t.nodeType === 1 && ( s = t.style.display, n = t.previousSibling, r = t.nextSibling, i = t.parentNode, this._elemBack = function() {
		...
		follow : function(t) {
			...
			return x = x < N ? g : x + E > l && g - E > N ? g - E + v : x, T = T + S > c + C && y - S > C ? y - S : T, w.left = parseInt(x) + "px", w.top = parseInt(T) + "px", this._follow && this._follow.removeAttribute(s), this._follow = t, t[s] = r.id, this
		},
		button : function() {
			...
			for (; a < o.length; a++)
				f = o[a], l = f.value, c = f.id || l, h = !s[c], p = h ? document.createElement("input") : s[c].elem, p.type = "button", p.className = "d-button", s[c] || (s[c] = {}), l && (p.value = l), f.width && (p.style.width = f.width), f.callback && (s[c].callback = f.callback), f.focus && (this._focus && this._focus.removeClass(i), this._focus = e(p).addClass(i), this.focus()), p[u + "callback"] = c, p.disabled = !!f.disabled, h && (s[c].elem = p, r.appendChild(p));
		...
		close : function() {
			...
			if (i && i.call(this) === !1)
				return this;
			c.focus === this && (c.focus = null), this._follow && this._follow.removeAttribute(u + "follow"), this._elemBack && this._elemBack(), this.time(), this.unlock(), this._removeEvent(),
			delete n[this.config.id];
			if (r)
				t.remove();
			else {
				r = this, e.title.html(""), e.content.html(""), e.buttons.html(""), t[0].className = t[0].style.cssText = "", e.outer[0].className = "d-outer", t.css({
					left : 0,
					top : 0,
					position : l ? "fixed" : "absolute"
				});
				for (var o in this)this.hasOwnProperty(o) && o !== "dom" &&
				delete this[o];
				this.hidden()
			}
			return s && s.focus(), this.closed = !0, this
		},
		time : function(e) {
		...
		lock : function() {
			...
			return this.zIndex(), i.outer.addClass("d-state-lock"), o.css({
				zIndex : u,
				position : "fixed",
				left : 0,
				top : 0,
		...
		_innerHTML : function(n) {
			...
			for (; o < f; o++)
				s = a[o].className.split("d-")[1], s && (u[s] = e(a[o]));
		...
		if (!i || !i.config.esc || r.test(n) && t.type !== "button")
			return;
		...
		for (var t in e)
		e[t]._reset()
	}), c._templates = '<div class="d-outer" role="dialog" tabindex="-1" aria-labelledby="d-title-{id}" aria-describedby="d-content-{id}"><table class="d-border"><tbody><tr><td class="d-nw"></td><td class="d-n"></td><td class="d-ne"></td></tr><tr><td class="d-w"></td><td class="d-c"><div class="d-inner"><table class="d-dialog"><tbody><tr><td class="d-header"><div class="d-titleBar"><div id="d-title-{id}" class="d-title"></div><a class="d-close" href="javascript:;">\u00d7</a></div></td></tr><tr><td class="d-main"><div id="d-content-{id}" class="d-content"></div></td></tr><tr><td class="d-footer"><div class="d-buttons"></div></td></tr></tbody></table></div></td><td class="d-e"></td></tr><tr><td class="d-sw"></td><td class="d-s"></td><td class="d-se"></td></tr></tbody></table></div>', c.defaults = {
		...
		fixed : !1,
		zIndex : 1987
	}, this.artDialog = e.dialog = e.artDialog = c
